...
public class ExtentFactory {
	...
	public static void clickFail(String btnName) {
		getInstance().getExtentTest().fail("Error occred while clicking on " + btnName);
	}

	public static void sendKeysPass(String value, String elementName) {
		getInstance().getExtentTest().pass(value + " value is entered in " + elementName);
	}

	public static void sendKeysFail(String value, String elementName) {
		getInstance().getExtentTest()
				.fail("Error occured while entering value " + value + " in textbox " + elementName);
	}
